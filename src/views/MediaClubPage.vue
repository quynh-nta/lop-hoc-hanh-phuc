...
const products = ref([
  {
    ...
    date: '20/01/2026',
    featured: true,
    fullContent: 'Video 5 phút ghi lại những khoảnh khắc vui vẻ, ý nghĩa trong một ngày học của lớp 5A. Từ giờ chào cờ đầu tuần, các tiết học sôi nổi, đến giờ ra chơi náo nhiệt. Đây là sản phẩm của cả nhóm sau 2 tuần quay và dựng.'
  },
  {
    id: 2,
